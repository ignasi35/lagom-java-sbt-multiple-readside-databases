...
/**
 * This is an event sourced entity. It has a state, {@link MultirdbmsjavaState}, which
 ...
 */
public class MultirdbmsjavaEntity extends PersistentEntity<MultirdbmsjavaCommand, MultirdbmsjavaEvent, MultirdbmsjavaState> {
    /**
     * An entity can define different behaviours for different states, but it will
     * always start with an initial behaviour. This entity only has one behaviour.
     */
    @Override
    public Behavior initialBehavior(Optional<MultirdbmsjavaState> snapshotState) {
        /*
        ...
        BehaviorBuilder b = newBehaviorBuilder(
                snapshotState.orElse(new MultirdbmsjavaState("Hello", LocalDateTime.now().toString()))
        );
        ...
        b.setEventHandler(GreetingMessageChanged.class,
                ...
                // the event.
                evt -> new MultirdbmsjavaState(evt.message, LocalDateTime.now().toString())
        );
